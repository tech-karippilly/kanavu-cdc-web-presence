  ...
  return (
    <>
      ...
      <section className="bg-primary-soft/40 py-16 sm:py-20">
        <div className="mx-auto grid max-w-7xl gap-6 px-4 sm:px-6 md:grid-cols-3 lg:px-8">
          {[
            ...
            <div key={title} className="rounded-3xl bg-card p-7 shadow-card">
      ...
      <section className="mx-auto max-w-4xl px-4 py-16 text-center sm:px-6 sm:py-20 lg:px-8">
        <h2 className="font-display text-3xl font-extrabold sm:text-4xl">Walk with us on this journey</h2>
